...
export default function OH31MapSimple2018({ activeRace, darkMode, townshipFilter, raceLabel, onMobilePopupChange, swingLookup, swingLabel }: Props) {
      ...
      >
        ...
        <Geographies geography={GEO_URL}>
          {({ geographies }: { geographies: PrecinctGeography[] }) =>
            geographies.map((geo) => {
              const name = (geo.properties?.NAME18 as string) ?? "";
              const precinct = oh31ByPrecinct2018[name];
                ...
                <Geography
                  ...
                  fill={(() => {
                    ...
                    if (swingLookup != null) {
                      ...
                      return entry !== undefined ? getRaceColor(entry.margin - absMargin) : (darkMode ? t.bg : t.panel);
                    }
