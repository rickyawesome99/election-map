...
export default function OH31MapSimple({ activeRace, darkMode, townshipFilter, raceLabel, onMobilePopupChange, swingLookup, swingLabel }: Props) {
              ...
              return (
                <Geography
                  ...
                  fill={(() => {
                    ...
                    if (!race) return "var(--oh31-simple-map-bg)";
                    const absMargin = race.dPct - race.rPct;
                    if (swingLookup != null) {
                      const entry = swingLookup[name];
                      return entry !== undefined ? getRaceColor(entry.margin - absMargin) : "var(--oh31-simple-map-bg)";
                    }
