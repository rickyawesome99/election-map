...
export default function OH31MapSimple2016({ activeRace, darkMode, townshipFilter, raceLabel, onMobilePopupChange, swingLookup, swingLabel }: Props) {
      ...
      >
        ...
        <Geographies geography={GEO_URL}>
          {({ geographies }: { geographies: PrecinctGeography[] }) =>
            geographies.map((geo) => {
              const name = (geo.properties?.NAME16 as string) ?? "";
              const precinct = oh31ByPrecinct2016[name];
