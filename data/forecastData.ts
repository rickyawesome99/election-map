...
// Current senate seat composition after the 2024 elections — NOT 2026 projections.
// Each value is [seat1Party, seat2Party]. Update with real names once data is entered.
...
// 2024 Presidential margin by state (positive = Harris, negative = Trump)
export const pres2024: Record<string, number> = {
  AL: -27.7, AK: -13.3, AZ:  -5.5, AR: -27.6, CA:  20.0,
  CO:  11.0, CT:  13.7, DE:  12.3, FL: -13.5, GA:  -2.2,
  HI:  27.9, ID: -29.5, IL:  14.5, IN: -17.8, IA: -12.9,
  KS: -20.0, KY: -25.5, LA: -20.1, ME:   5.0, MD:  25.8,
  MA:  28.8, MI:  -1.4, MN:   2.9, MS: -17.4, MO: -18.5,
  MT: -19.7, NE: -19.8, NV:  -3.1, NH:   1.9, NJ:   5.7,
  NM:   8.0, NY:  12.5, NC:  -3.2, ND: -32.8, OH: -11.2,
  OK: -33.8, OR:  14.3, PA:  -1.8, RI:  14.7, SC: -13.4,
  SD: -28.2, TN: -24.6, TX: -14.1, UT: -13.3, VT:  33.8,
  VA:   6.2, WA:  18.8, WV: -38.8, WI:  -0.9, WY: -43.3,
};
