...
out = [
    ...
    "// 2022: AK has no county-level House data from any source (same structural gap as",
    "// every other year/office in this project). IN excluded entirely - only 38 of its 92",
