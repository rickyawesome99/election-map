...
out = [
    ...
    "// 2020: AK's 29 boroughs ARE included this year - unlike 2022/2024, 2020 predates AK's",
    "// RCV system entirely (adopted starting the 2022 cycle), so this is a plain plurality",
    "// reconstruction from the state's official precinct-level results export, no ballot-",
    "// level CVR or IRV tabulation needed. Matches certified within ~0.2%. districts_2020",
    "// is [1] for every AK county. See data-entry/README-ak-cvr-reconstructions.md.",
    "// IN was excluded from MEDSL (only 53/92 counties present) and",
    ...
    "// 2018: AK's 29 boroughs ARE included this year - reconstructed from the state's",
    "// official precinct-level results (pre-RCV era, plain plurality, no CVR needed).",
    "// Matches certified within the excluded federal-overseas-ballot total only.",
    "// districts_2018 is [1] for every AK county. See",
    "// data-entry/README-ak-cvr-reconstructions.md. IN excluded from MEDSL (only 53/92 counties present) and fetched",
    ...
    "// 2016: AK's 29 boroughs ARE included this year - same official-precinct-data",
    "// reconstruction as 2018/2020/2022/2024 (pre-RCV era, plain plurality). This closes",
    "// out AK's House coverage for every year in YEARS above. See",
    "// data-entry/README-ak-cvr-reconstructions.md. IN fetched from its own SOS ENR portal (exact match, all 92",
