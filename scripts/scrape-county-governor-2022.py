#!/usr/bin/env python3
"""
Scrapes county-level 2022 Governor results from Wikipedia's "By county" tables
(e.g. https://en.wikipedia.org/wiki/2022_Texas_gubernatorial_election)
...
Writes data-entry/county_governor_results_2022.csv with columns:
...
Same parser as scripts/scrape-county-governor-2023.py / -2024.py / -2025.py /
scrape-county-senate-2024.py (all their wikitext-format bugfixes inherited,
including 2023's `line_sep()` fix for `!`-marker lines that join cells with `||`
instead of `!!`) - see those files' docstrings and
memory/project_county_election_scrape.md for the full list of gotchas this
parser already handles.

Run from project root: python3 scripts/scrape-county-governor-2022.py
"""
...
OUT_CSV = os.path.join(ROOT, "data-entry/county_governor_results_2022.csv")
...
STATE_NAMES = {
    ...
    "KS": "Kansas", "MA": "Massachusetts", "MD": "Maryland", "ME": "Maine",
    "MI": "Michigan", "MN": "Minnesota", "NE": "Nebraska", "NH": "New Hampshire",
    "NM": "New Mexico", "NV": "Nevada", "NY": "New York", "OH": "Ohio",
    "OK": "Oklahoma", "OR": "Oregon", "PA": "Pennsylvania", "RI": "Rhode Island",
    "SC": "South Carolina", "SD": "South Dakota", "TN": "Tennessee", "TX": "Texas",
    "VT": "Vermont", "WI": "Wisconsin", "WY": "Wyoming",
}
